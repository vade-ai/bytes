(ns index
  {:nextjournal.clerk/visibility {:code :hide}
   ...
   {:title "Vade Bytes - Learning Out Loud"
    :description "Raw notes, not performance art. Written for truth, not virality. Interactive learning resources with spaced repetition."
    :url "https://vade-ai.github.io/bytes/"
